...
class TestStockLogisticsWarehouse(TransactionCase):
    def test_res_config(self):
        ...
        self.assertEqual(stock_setting.xtendoo_stock_available_mrp_based_on, "qty_available")
        stock_setting.xtendoo_stock_available_mrp_based_on = "immediately_usable_qty"
