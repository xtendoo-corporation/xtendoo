...
"""Tests for xtendoo_whatsapp_onboarding (Odoo 19).
...
TEMPLATE_REQUESTS_TARGET = "odoo.addons.xtendoo_mail_gateway_whatsapp.models.mail_gateway.requests"
...
class TestWhatsappOnboarding(TransactionCase):
    ...
    def test_13_user_without_access_group(self):
        # xtendoo_mail_gateway grants read-only access to plain internal users by
