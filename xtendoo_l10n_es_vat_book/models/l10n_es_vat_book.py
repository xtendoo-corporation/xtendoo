...
class L10nEsVatBook(models.Model):
    ...
    def view_issued_invoices(self):
        self.ensure_one()
        report_name = "xtendoo_l10n_es_vat_book.report_vat_book_invoices_issued_html"
        return (
    ...
    def view_received_invoices(self):
        self.ensure_one()
        report_name = "xtendoo_l10n_es_vat_book.report_vat_book_invoices_received_html"
        return (
            self.env["ir.actions.report"]
            .search(
                [("report_name", "=", report_name), ("report_type", "=", "qweb-html")],
    ...
    def export_xlsx(self):
        self.ensure_one()
        return self.env.ref("xtendoo_l10n_es_vat_book.l10n_es_vat_book_xlsx").report_action(
            self
        )
