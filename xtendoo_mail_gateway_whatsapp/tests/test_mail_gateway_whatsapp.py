...
from odoo.addons.xtendoo_mail_gateway.tests.common import MailGatewayTestCase
...
class TestMailGatewayWhatsApp(MailGatewayTestCase):
    ...
    @mute_logger("odoo.addons.xtendoo_mail_gateway.controllers.gateway")
    ...
    def test_send_document_error(self):
        ...
        with mute_logger(
            "odoo.addons.xtendoo_mail_gateway_whatsapp.models.xtendoo_mail_gateway_whatsapp"
        ):
