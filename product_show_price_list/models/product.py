    ...
    def _compute_price_list(self):
        ...
        for product in self:
            ...
            for product_item_id in product.item_ids:
                ...
                if product_item_id.pricelist_id.name == "T-09: DILUIDA":
                    product.pricelist_9 = product_item_id.fixed_price
